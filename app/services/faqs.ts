// Single source of truth for the /services FAQ. The visible HTML (rendered
// by FAQAccordion) and the FAQPage JSON-LD (emitted by app/services/page.tsx)
// both import this array, so the schema is guaranteed to match the page
// content — a hard requirement for Google's rich-result eligibility.
//
// All numeric values flow from config/site.ts. Edit prices/policies there
// and the FAQs (and their schema) update automatically.
